...
import type { QueueStoreEntry, UnidentifiedQueueStoreEntry } from './lib/QueueDb'
 ...
 * @private
 */
function convertEntry(queueStoreEntry: UnidentifiedQueueStoreEntry): QueueEntry {
...
class Queue {
   ...
   * @param {number} [options.maxRetentionTime] The amount of time (in
   *     minutes) a request may be retried. After this amount of time has
   *     passed, the request will be deleted from the queue.
   * @param {boolean} [options.forceSyncFallback] If `true`, instead
