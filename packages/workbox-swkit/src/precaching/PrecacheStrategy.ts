...
import type { StrategyOptions } from '../strategies/Strategy'
import type { StrategyHandler } from '../strategies/StrategyHandler'
import { copyResponse } from '../core/index'
import { privateCacheNames as cacheNames, getFriendlyURL, logger, WorkboxError } from '../core/internals'
...
class PrecacheStrategy extends Strategy {
  ...
  constructor(options: PrecacheStrategyOptions = {}) {
    ...
    this._fallbackToNetwork
      = options.fallbackToNetwork !== false
