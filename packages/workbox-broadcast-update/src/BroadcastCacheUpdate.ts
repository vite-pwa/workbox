...
import type { CacheDidUpdateCallbackParam } from '@vite-pwa/workbox-core'
import { assert, logger, resultingClientExists, timeout } from '@vite-pwa/workbox-core/internals'
...
class BroadcastCacheUpdate {
   ...
   * @param {boolean} [options.notifyAllClients] If true (the default) then
