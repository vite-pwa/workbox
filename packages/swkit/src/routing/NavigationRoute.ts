...
import type { RouteHandler, RouteMatchCallbackOptions } from '../core/types'
import { assert, logger } from '../core/internals'
...
export const DefaultAllowListRegex = /./
...
class NavigationRoute extends Route {
  ...
  constructor(
    ...
    { allowlist = [DefaultAllowListRegex], denylist = [] }: NavigationRouteMatchOptions = {},
  ) {
