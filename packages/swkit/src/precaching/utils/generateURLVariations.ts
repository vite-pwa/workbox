...
import { removeIgnoredSearchParams } from './removeIgnoredSearchParams'

export const IgnoreURLParametersMatchingRegex = [/^utm_/, /^fbclid$/]
...
export function* generateURLVariations(
  url: string,
  {
    ignoreURLParametersMatching = IgnoreURLParametersMatchingRegex,
