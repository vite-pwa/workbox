...
import type { RouteHandler, RouteHandlerCallbackOptions } from '@vite-pwa/workbox-core'
import { matchPrecache } from '@vite-pwa/workbox-precaching'
import { setCatchHandler } from '@vite-pwa/workbox-routing'
