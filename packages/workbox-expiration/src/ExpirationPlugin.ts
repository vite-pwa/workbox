...
import { registerQuotaErrorCallback } from '@vite-pwa/workbox-core'
import { assert, privateCacheNames as cacheNames, dontWaitFor, getFriendlyURL, logger, WorkboxError } from '@vite-pwa/workbox-core/internals'
