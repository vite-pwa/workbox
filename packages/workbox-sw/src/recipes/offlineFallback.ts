...
import type { RouteHandler, RouteHandlerCallbackOptions } from '../core/types'
import { matchPrecache } from '../precaching/matchPrecache'
import { setCatchHandler } from '../routing/setCatchHandler'
